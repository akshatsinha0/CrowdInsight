    ...
    <div class="analysis-display">
      ...
      <div class="analysis-content">
        <div class="analysis-grid">
          <div class="analysis-visualization card">
          ...
          <div class="analysis-metrics card">
            ...
            <div class="metrics-content">
              <div class="metric-item">
                ...
                <div class="metric-value">{{ analysisData.count }}</div>
              </div>
              
              <div class="metric-item">
                <div class="metric-label">Crowd Type</div>
                <div class="metric-value">{{ analysisData.crowd_type }}</div>
              </div>
              
              <div class="metric-item">
                <div class="metric-label">Distribution Pattern</div>
                <div class="metric-value">{{ analysisData.distribution.pattern }}</div>
              </div>
        ...
        <div class="analysis-details card">
          ...
          <div class="details-content">
            <div class="details-section">
              ...
              <p>
                {{ analysisData.hotspots.length }} distinct hotspots were identified in the crowd.
                The largest concentration is found in the upper central region with an
                intensity of {{ Math.round(analysisData.hotspots[0].intensity * 100) }}%
                spanning an area of approximately {{ analysisData.hotspots[0].area }} square pixels.
              </p>
            </div>
            
            <div class="details-section">
              <h5>Crowd Behavior</h5>
              <p>
                The crowd exhibits a {{ analysisData.distribution.pattern.toLowerCase() }} pattern
                with a uniformity index of {{ Math.round(analysisData.distribution.uniformity * 100) }}%.
                This suggests a {{ analysisData.distribution.uniformity > 0.7 ? 'highly organized' : 'typical' }}
                crowd structure consistent with {{ analysisData.crowd_type.toLowerCase() }} scenarios.
              </p>
            </div>
            ...
            <div class="details-section">
              ...
              <p>
                Based on density and distribution analysis, the risk level is assessed as
                <span :class="`risk-${analysisData.risk_level.level.toLowerCase()}`">{{ analysisData.risk_level.level }}</span>
                with a score of {{ Math.round(analysisData.risk_level.score * 100) }}/100.
                {{ getRiskRecommendation(analysisData.risk_level.level) }}
              </p>
            </div>
          </div>
        </div>
